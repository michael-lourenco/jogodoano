...
export default function About() {
  ...
  const categories = [
    {
      icon: "LuTrophy" as IconName,
      name: "Jogo do Ano"
    },
    {
      icon: "LuSwords" as IconName,
  ...
  const faqs = [
    {
      ...
      answer: "Qualquer pessoa com uma conta na plataforma pode participar da votação. Basta fazer login e começar a votar nas categorias disponíveis."
    },
    {
      question: "Quando acontece a premiação?",
      answer: "A votação geralmente ocorre durante o mês de novembro, e os resultados são anunciados em dezembro, em um evento especial transmitido online."
    },
    {
      question: "Posso alterar meus votos?",
      answer: "Sim, você pode alterar seus votos a qualquer momento durante o período de votação aberta. Após o encerramento, os votos são finalizados."
    },
    {
      question: "Como os vencedores são determinados?",
      answer: "Os vencedores são determinados exclusivamente pelos votos dos usuários. O jogo com maior número de votos em cada categoria é declarado vencedor."
    }
  ]
  ...
  const votingSteps = [
    {
      icon: "LuUser" as IconName,
      title: "Crie sua conta",
      description: "Faça login com sua conta Google ou outro provedor para começar a votar."
    },
    {
      icon: "LuLayoutList" as IconName,
      title: "Navegue pelas categorias",
      description: "Explore as diferentes categorias disponíveis para votação."
    },
    {
      icon: "LuCheck" as IconName,
      title: "Escolha seus favoritos",
      description: "Selecione os jogos que você acredita merecerem o reconhecimento em cada categoria."
    },
    {
      icon: "LuSend" as IconName,
      title: "Envie seus votos",
      description: "Confirme suas escolhas e envie seus votos para participar da premiação."
    }
  ]
              ...
              <Tabs defaultValue="about" value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <div ref={contentRef} className="p-4 md:p-6">
                    ...
                    >
                      ...
                      <div className="p-4 md:p-5 bg-primary/5 rounded-lg border border-primary/10 mb-4 md:mb-6">
                        <h3 className="flex items-center gap-2 font-semibold text-primary mb-2 md:mb-3 text-base md:text-lg">
                          <Icon name="LuCalendar" className="w-4 h-4 md:w-5 md:h-5" />
                          Ciclo Anual
                        </h3>
                  ...
                  <TabsContent value="categories" className="mt-0">
                    ...
                    >
                      <h2 className="text-xl md:text-2xl font-bold flex items-center gap-2 mb-3 md:mb-4 text-primary">
                        <Icon name="LuList" className="w-5 h-5 md:w-6 md:h-6" /> 
                      ...
                      <div className="mt-6 md:mt-8 p-4 md:p-5 bg-muted/10 rounded-lg border border-muted">
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 text-xs md:text-sm">
                          <li className="flex items-start gap-2">
                            <Icon name="LuCalendar" className="w-4 h-4 text-primary mt-0.5" />
